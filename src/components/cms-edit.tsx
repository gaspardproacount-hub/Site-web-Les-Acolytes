...
// pour qu'elle ouvre directement le bon champ ou produit.
...
export function CmsAddTile({
  ...
  return (
    <button
      ...
      className="flex min-h-[56px] w-full items-center justify-center rounded-xl border-2 border-dashed border-ink/30 bg-ink/5 text-sm font-medium text-ink hover:bg-ink/10"
    >
      {label}
    </button>
  );
